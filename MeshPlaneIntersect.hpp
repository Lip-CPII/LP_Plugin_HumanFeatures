...
public:
    ...
    public:
        ...
        static std::vector<FloatType> o_vertexOffsets;
        static std::vector<EdgePath> o_edgePaths;
    ...
    private:
        ...
        static std::vector<Path3D> _Execute(const Mesh& mesh, const Plane& plane,
            ...
            //o_vertexOffsets = vertexOffsets;
            o_edgePaths = edgePaths;
...
//template<> std::vector<float> MeshPlaneIntersect<float,int>::Mesh::o_vertexOffsets = std::vector<float> ();
