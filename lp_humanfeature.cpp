...
void LP_HumanFeature::member::updateReference()
{
    int nParas = 7;
...
void LP_HumanFeature::member::rationalize()
{
...
bool LP_HumanFeature::member::checkConvexHull(const std::vector<std::vector<double> > &cvxHull,
...
void LP_HumanFeature::member::setParameters(const std::vector<double> &in)
{
    parameters = in;
}
